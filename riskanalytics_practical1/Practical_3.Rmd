...
Grafico:
1. plot all products with threshold 
2. Chi plot 

Matematico:
1. Correlation matrix (chibar) 

Products aggregation:
- Clustering based on Kendall Taus distance 
- Grafico con mean and variance 
...
If the extreme value distributions follow a normal distribution than yes, otherwise no. 
=> check 
...
transform_to_uniform(sales10adj, cdf = ismev::gev.fit, threshold = 150)
