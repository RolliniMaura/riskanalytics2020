...
Now,  we will evaluate the goodness of fit and the quantiles plot
...
plot.gof(gofTest(data_extreme_gpd, distribution = "pareto",test = "ks"))
...
- We want to avoid overfitting that  is more common with the GEV model.
